...
class DinningroomPageAdpter (private val title: List<String>, private val activity : Context) :
    ...
    public fun initView(){
        ...
        views[0].banner_qxh.setImages(image)
        ...
        views[0].tv_guide_dining_room_detail.setText(stringBuilder.toString())

        views[1].banner_ys.setImages(image)
        ...
        views[1].tv_guide_dining_room_detail.setText(stringBuilder.toString())

        views[2].banner_hgl.setImages(image)
        ...
        views[2].tv_guide_dining_room_detail.setText(stringBuilder.toString())

        views[3].banner_zzst.setImages(image)
        ...
        views[3].tv_guide_dining_room_detail.setText(stringBuilder.toString())

        views[4].banner_dxb.setImages(image)
        ...
        views[4].tv_guide_dining_room_detail.setText(stringBuilder.toString())
    }
}
